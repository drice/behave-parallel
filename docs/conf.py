...
# -----------------------------------------------------------------------------
project = "behave"
authors = "Benno Rice, Richard Jones and Jens Engel"
copyright = "2012-2017, %s" % authors
...
man_pages = [("index", "behave", "behave Documentation", [authors], 1)]
...
texinfo_documents = [
    (
        ...
        authors,
        "behave",
        "A test runner for behave (feature tests).",
        "Miscellaneous",
    ),
]
